...
//		init(0x0F);
	...
	public void clone(RtpPacket rtpPacket)
	{
		System.arraycopy(packet, 0, rtpPacket.packet, 0, packet_len);
		rtpPacket.packet_len = packet_len;
	}
